...
%
% $Id: library.tex,v 1.1.1.1 2002/10/19 08:27:43 aida_s Exp $
%
...
\begin{tabular}{lp{1.7cm}p{12.8cm}}
(1) & \HIDX{jrkanji.h}{ＪＲＫＡＮＪＩ．Ｈ}{H0.9.1.2.0.a}\hptar{label=H0.9.1.2.0.a}  & (/usr/include/canna) TTYレベルの日本語の入出力を行うときに必要なヘッダファイルです。\\
(2) & \HIDX{RK.h}{ＲＫ．Ｈ}{H0.9.1.2.0.b}\hptar{label=H0.9.1.2.0.b}  & (/usr/include/canna) RKライブラリを使用するとき必要なヘッダファイルです。\\
\end{tabular}
