...
%
% $Id: custom.tex,v 1.1.1.1 2002/10/19 08:27:42 aida_s Exp $
%
\chapter{カスタマイズ}
\label{3.3カスタマイズ}
...
マイズファイル \\ 
\hline
vje.kp     & vje$-\beta$\footnotemark とほぼ同じキー操作を提供するカス
タマイズファイル \\ 
\hline 
wx2+.kp     & WXII+\footnotemark とほぼ同じキー操作を提供するカスタマ
イズファイル \\ 
\hline 
\end{tabular}
\end{center}
...
\begin{nquote}{3em}
\begin{enumerate}
\item \verb+% setenv  CANNAFILE  /usr/lib/canna/sample/just.canna +
\item \verb+% cp  /usr/lib/canna/sample/just.canna  ~/.canna +
\end{enumerate}
\end{nquote}
...
\hline
 %%%%% %%%%% %%%%% %%%%% %%%%% %%%%%
 %jdaemon.kp  & EWS-UX/V R6.×以前の日本語入力システムと互換のローマ字
 %かな変換テーブル \\ 
 %\hline
 %%%%% %%%%% %%%%% %%%%% %%%%% %%%%%
just.kp     & 一太郎\footnotemark と同一のローマ字かな変換規則を持つロー
マ字かな変換テー ブル \\
\hline
matsu.kp     & 松茸\footnotemark と同一のローマ字かな変換規則を持つロー
マ字かな変換テーブル \\ 
\hline
vje.kp     & vje$-\beta$\footnotemark と同一のローマ字かな変換規則を持
つローマ字かな変換 テーブル \\ 
\hline
wx2+.kp     & WXII+\footnotemark と同一のローマ字かな変換規則を持つロー
マ字かな変換テーブル \\
\hline
...
イルである \\ 
\refCANNALIBDIR /sample/src/default.kpdef をコピーして書き換えるのが簡
単です。 
...
\HIDX{:user}{：ＵＳＥＲ}{H0.4.6.4.0.1} を先行させます。
