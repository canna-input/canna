...
extern char *get_kbd_env pro((void));
#if !(HAVE_SETENV)
...
extern int convert_getterm pro((char *, int));
...
extern int flush_designate pro((w_char *));
extern int jtosj ();
extern int jutil ();
extern int kakutei ();
extern int kana_in ();
...
extern void print_buf_msg pro((char *));
extern void reset_cursor ();
extern void push_cursor ();
extern void push_hrus ();
extern void putchar1 pro((int));
extern void putchar_norm pro((int));
extern void puteustring pro((char *, FILE *));
...
extern void reset_bold pro((int));
...
extern void set_bold pro((int));
extern void set_cursor_status ();
extern void set_escape_code ();
extern void set_hanten_ul pro((int, int));
extern void set_lc_offset ();
extern void set_screen_vars_default ();
extern void set_keypad_on ();
extern void set_keypad_off ();
extern void set_scroll_region pro((int, int));
extern int st_colum ();
extern void t_cont_line_note_delete ();
extern int t_delete_char ();
extern int t_kill ();
extern int t_move pro((int));
extern int t_print_l ();
extern void t_print_line pro((int, int, int));
extern int t_redraw_move pro((int, int, int, int));
extern int t_rubout ();
extern void t_throw ();
extern int t_yank ();
extern int tan_conv ();
extern int tan_henkan1 ();
extern void throw_col pro((int));
extern void throw_cur_raw pro((int, int));
extern void touroku ();
extern void u_s_off ();
...
extern w_char *Strncpy pro((w_char *, w_char *, int));
extern int Strlen ();
extern void conv_ltr_to_ieuc ();
extern int get_cswidth_by_char pro((int));
extern int eeuc_to_ieuc ();
extern int conv_keyin pro((char *));
